      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build inventoryApp
<span># Test</span>
nx test inventoryApp
<span># Lint</span>
nx lint inventoryApp
<span># Run them together!</span>
nx run-many -p inventoryApp -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project inventoryApp</pre>
          </details>
