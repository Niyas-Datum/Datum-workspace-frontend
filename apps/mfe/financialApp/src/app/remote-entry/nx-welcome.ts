      ...
      <div class="container">
        ...
        <div id="commands" class="rounded shadow">
          ...
          <details>
            ...
            <pre><span># Build</span>
nx build financialApp
<span># Test</span>
nx test financialApp
<span># Lint</span>
nx lint financialApp
<span># Run them together!</span>
nx run-many -p financialApp -t build test lint</pre>
          </details>
          <details>
            <summary>
              <svg
            ...
            <pre>nx show project financialApp</pre>
          </details>
